...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/index.js */ \"../src/index.js\");\n/* harmony import */ var _database__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./database */ \"./database.js\");\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest(); }\n\nfunction _nonIterableRest() { throw new TypeError(\"Invalid attempt to destructure non-iterable instance\"); }\n\nfunction _iterableToArrayLimit(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i[\"return\"] != null) _i[\"return\"](); } finally { if (_d) throw _e; } } return _arr; }\n\nfunction _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }\n\n\n\nvar DEFAULT_FRONTEND_URL = 'https://staging-bus.wealthscope.ca';\n\nfunction setAlert(message) {\n  var el = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : $('#error');\n  el.html(message);\n  el.css({\n    display: 'block'\n  });\n}\n\nfunction clearAlert() {\n  var el = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : $('#error');\n  el.html('');\n  el.css({\n    display: 'none'\n  });\n} // Set cookie helper\n\n\nfunction setCookie(cname, cvalue, exdays) {\n  var d = new Date();\n  d.setTime(d.getTime() + exdays * 24 * 60 * 60 * 1000);\n  var expires = \"expires=\" + d.toUTCString();\n  document.cookie = cname + \"=\" + cvalue + \";\" + expires + \";path=/\";\n} // Get cookie helper\n\n\nfunction getCookie(cname) {\n  var name = cname + \"=\";\n  var decodedCookie = decodeURIComponent(document.cookie);\n  var ca = decodedCookie.split(';');\n\n  for (var i = 0; i < ca.length; i++) {\n    var c = ca[i];\n\n    while (c.charAt(0) == ' ') {\n      c = c.substring(1);\n    }\n\n    if (c.indexOf(name) == 0) {\n      return c.substring(name.length, c.length);\n    }\n  }\n\n  return \"\";\n} // Used to parse serialized form data into an object\n\n\nfunction parseFormData(data) {\n  var formData = {};\n  data.split('&').forEach(function (inputData) {\n    var _inputData$split = inputData.split('='),\n        _inputData$split2 = _slicedToArray(_inputData$split, 2),\n        name = _inputData$split2[0],\n        value = _inputData$split2[1];\n\n    formData[name] = value;\n  });\n  return formData;\n}\n\nfunction saveFormData(_x) {\n  return _saveFormData.apply(this, arguments);\n} // Generate a JWT using options passed through cfg\n\n\nfunction _saveFormData() {\n  _saveFormData = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee3(data) {\n    var _arr2, _i2, key;\n\n    return regeneratorRuntime.wrap(function _callee3$(_context3) {\n      while (1) {\n        switch (_context3.prev = _context3.next) {\n          case 0:\n            _arr2 = Object.keys(data);\n            _i2 = 0;\n\n          case 2:\n            if (!(_i2 < _arr2.length)) {\n              _context3.next = 9;\n              break;\n            }\n\n            key = _arr2[_i2];\n            _context3.next = 6;\n            return _database__WEBPACK_IMPORTED_MODULE_1__[\"default\"].formData.put({\n              key: key,\n              value: data[key]\n            });\n\n          case 6:\n            _i2++;\n            _context3.next = 2;\n            break;\n\n          case 9:\n          case \"end\":\n            return _context3.stop();\n        }\n      }\n    }, _callee3, this);\n  }));\n  return _saveFormData.apply(this, arguments);\n}\n\nfunction generateJWT(_x2) {\n  return _generateJWT.apply(this, arguments);\n} // Re/configure the SDK and refresh the page\n\n\nfunction _generateJWT() {\n  _generateJWT = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee4(cfg) {\n    var partnerId, privateKey, payload, validConfig, timeNow, timeEnd, header, payloadObj, jsonHeader, jsonPayload, rsa, jwt;\n    return regeneratorRuntime.wrap(function _callee4$(_context4) {\n      while (1) {\n        switch (_context4.prev = _context4.next) {\n          case 0:\n            partnerId = cfg.partnerId, privateKey = cfg.privateKey, payload = cfg.payload; // Check if required parameters were passed\n\n            validConfig = partnerId && privateKey && payload;\n\n            if (validConfig) {\n              _context4.next = 4;\n              break;\n            }\n\n            throw new TypeError('Invalid JWT data.');\n\n          case 4:\n            // Create the token header\n            timeNow = KJUR.jws.IntDate.get('now');\n            timeEnd = KJUR.jws.IntDate.get('now + 1day');\n            header = {\n              alg: 'RS512',\n              typ: 'JWT',\n              nbf: timeNow,\n              exp: timeEnd\n            }; // Decode and parse the payload\n\n            payloadObj = JSON.parse(decodeURIComponent(payload)); // JSON stringify the header and payload\n\n            jsonHeader = JSON.stringify(header);\n            jsonPayload = JSON.stringify(_objectSpread({}, payloadObj, {\n              partner_name: partnerId\n            })); // Create a private key object\n            // const rsa = new RSAKey();\n            // rsa.readPrivateKeyFromPEMString(privateKey);\n\n            rsa = KEYUTIL.getKey(decodeURIComponent(privateKey)); // Generate the JWT\n\n            jwt = KJUR.jws.JWS.sign(null, jsonHeader, jsonPayload, rsa);\n            return _context4.abrupt(\"return\", jwt);\n\n          case 13:\n          case \"end\":\n            return _context4.stop();\n        }\n      }\n    }, _callee4, this);\n  }));\n  return _generateJWT.apply(this, arguments);\n}\n\nfunction configureSDK(_x3) {\n  return _configureSDK.apply(this, arguments);\n}\n\nfunction _configureSDK() {\n  _configureSDK = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee5(cfg) {\n    var opts, frontendUrl, partnerId, privateKey, payload, validJWTConfig, token, dataToSave;\n    return regeneratorRuntime.wrap(function _callee5$(_context5) {\n      while (1) {\n        switch (_context5.prev = _context5.next) {\n          case 0:\n            opts = Object.assign({}, {\n              partnerId: '',\n              privateKey: '',\n              payload: {},\n              frontendUrl: ''\n            }, cfg);\n            frontendUrl = opts.frontendUrl, partnerId = opts.partnerId, privateKey = opts.privateKey, payload = opts.payload;\n            validJWTConfig = partnerId && privateKey && payload;\n\n            if (validJWTConfig) {\n              _context5.next = 5;\n              break;\n            }\n\n            throw new TypeError('Invalid JWT data.');\n\n          case 5:\n            _context5.prev = 5;\n            _context5.next = 8;\n            return generateJWT({\n              partnerId: partnerId,\n              privateKey: privateKey,\n              payload: payload\n            });\n\n          case 8:\n            token = _context5.sent;\n            _context5.next = 11;\n            return login(token);\n\n          case 11:\n            _context5.next = 17;\n            break;\n\n          case 13:\n            _context5.prev = 13;\n            _context5.t0 = _context5[\"catch\"](5);\n            console.error(_context5.t0);\n            throw new Error('Invalid JWT data.');\n\n          case 17:\n            // Save all the data\n            dataToSave = {\n              partnerId: partnerId,\n              privateKey: privateKey,\n              payload: payload\n            };\n\n            if (frontendUrl) {\n              dataToSave['frontendUrl'] = frontendUrl;\n            }\n\n            _context5.next = 21;\n            return saveFormData({\n              partnerId: partnerId,\n              privateKey: privateKey,\n              payload: payload,\n              frontendUrl: frontendUrl\n            });\n\n          case 21:\n            if (frontendUrl) {\n              window.location.reload();\n            } // Save the JWT as a cookie to avoid generating it again\n\n\n            setCookie('jwt', token);\n\n          case 23:\n          case \"end\":\n            return _context5.stop();\n        }\n      }\n    }, _callee5, this, [[5, 13]]);\n  }));\n  return _configureSDK.apply(this, arguments);\n}\n\nfunction login(_x4) {\n  return _login.apply(this, arguments);\n}\n\nfunction _login() {\n  _login = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee6(jwt) {\n    return regeneratorRuntime.wrap(function _callee6$(_context6) {\n      while (1) {\n        switch (_context6.prev = _context6.next) {\n          case 0:\n            if (jwt) {\n              _context6.next = 2;\n              break;\n            }\n\n            throw new TypeError('JWT is required to login.');\n\n          case 2:\n            if (window.ws) {\n              _context6.next = 4;\n              break;\n            }\n\n            throw new Error('Attempted to login when the WealthscopeSdk has not been initialized yet.');\n\n          case 4:\n            // Proceed to login with the SDK\n            window.ws.login(jwt); // Clear all errors\n\n            clearAlert($('#error'));\n            clearAlert($('#modal-error'));\n            clearAlert($('#warning'));\n\n          case 8:\n          case \"end\":\n            return _context6.stop();\n        }\n      }\n    }, _callee6, this);\n  }));\n  return _login.apply(this, arguments);\n}\n\nfunction initialize() {\n  return _initialize.apply(this, arguments);\n}\n\nfunction _initialize() {\n  _initialize = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee7() {\n    var storedJWT, savedFormData, frontendUrl;\n    return regeneratorRuntime.wrap(function _callee7$(_context7) {\n      while (1) {\n        switch (_context7.prev = _context7.next) {\n          case 0:\n            storedJWT = getCookie('jwt');\n            _context7.next = 3;\n            return _database__WEBPACK_IMPORTED_MODULE_1__[\"default\"].formData.toArray();\n\n          case 3:\n            savedFormData = _context7.sent;\n            frontendUrl = savedFormData.find(function (_ref3) {\n              var key = _ref3.key;\n              return key === 'frontendUrl';\n            }); // Restore the saved options\n\n            savedFormData.forEach(function (_ref4) {\n              var key = _ref4.key,\n                  value = _ref4.value;\n              $(\"input[name=\".concat(key, \"]\")).val(decodeURIComponent(value));\n              $(\"textarea[name=\".concat(key, \"]\")).val(decodeURIComponent(value));\n            }); // Initialize the WealthscopeSdk\n\n            window.ws = new _src_index_js__WEBPACK_IMPORTED_MODULE_0__[\"WealthscopeSdk\"]({\n              wealthscopeUrl: frontendUrl && frontendUrl.value && decodeURIComponent(frontendUrl.value) || DEFAULT_FRONTEND_URL\n            }); // Render the iFrame\n\n            window.ws.render(document.getElementById('ws')); // Display warning if no previous data has been saved\n\n            if (!storedJWT) {\n              _context7.next = 19;\n              break;\n            }\n\n            _context7.prev = 9;\n            _context7.next = 12;\n            return login(storedJWT);\n\n          case 12:\n            _context7.next = 18;\n            break;\n\n          case 14:\n            _context7.prev = 14;\n            _context7.t0 = _context7[\"catch\"](9);\n            console.error(_context7.t0);\n            setAlert(_context7.t0.message || _context7.t0, $('#error'));\n\n          case 18:\n            return _context7.abrupt(\"return\");\n\n          case 19:\n            // Set an alert warning that they need to configure the SDK\n            setAlert('You must configure the SDK before you can use it.', $('#warning'));\n\n          case 20:\n          case \"end\":\n            return _context7.stop();\n        }\n      }\n    }, _callee7, this, [[9, 14]]);\n  }));\n  return _initialize.apply(this, arguments);\n}\n\n$(document).ready(\n/*#__PURE__*/\n_asyncToGenerator(\n/*#__PURE__*/\nregeneratorRuntime.mark(function _callee2() {\n  return regeneratorRuntime.wrap(function _callee2$(_context2) {\n    while (1) {\n      switch (_context2.prev = _context2.next) {\n        case 0:\n          $('#options-form').submit(\n          /*#__PURE__*/\n          function () {\n            var _ref2 = _asyncToGenerator(\n            /*#__PURE__*/\n            regeneratorRuntime.mark(function _callee(e) {\n              var formData;\n              return regeneratorRuntime.wrap(function _callee$(_context) {\n                while (1) {\n                  switch (_context.prev = _context.next) {\n                    case 0:\n                      e.preventDefault(); // Get the form data\n\n                      formData = parseFormData($(this).serialize()); // Configure the SDK\n\n                      _context.prev = 2;\n                      _context.next = 5;\n                      return configureSDK(formData);\n\n                    case 5:\n                      _context.next = 11;\n                      break;\n\n                    case 7:\n                      _context.prev = 7;\n                      _context.t0 = _context[\"catch\"](2);\n                      console.error(_context.t0);\n                      return _context.abrupt(\"return\", setAlert(_context.t0.message || _context.t0, $('#modal-error')));\n\n                    case 11:\n                      clearAlert($('#modal-error'));\n                      $('#configureSDKModal').modal('hide');\n\n                    case 13:\n                    case \"end\":\n                      return _context.stop();\n                  }\n                }\n              }, _callee, this, [[2, 7]]);\n            }));\n\n            return function (_x5) {\n              return _ref2.apply(this, arguments);\n            };\n          }()); // Handle configure SDK modal on save\n\n          $('#configureSDKButton').click(function (e) {\n            $('#options-form').submit();\n          });\n          initialize();\n\n        case 3:\n        case \"end\":\n          return _context2.stop();\n      }\n    }\n  }, _callee2, this);\n})));\n\n//# sourceURL=webpack:///./index.js?");
...
eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! /Users/andras/Documents/Workspace/wealthscope-partner-sdk/examples/index.js */\"./index.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./index.js?");
